    ...
    pcall(function()
        ...
        if thismob:FindFirstChild('HumanoidRootPart') and thismob.Parent and (thismob:FindFirstChild('Humanoid') and 0 < thismob.Humanoid.Health) then
            repeat
                ...
                NoClip = true
            until not (thismob.Parent and thismob:FindFirstChild('Humanoid')) or (thismob:FindFirstChild('Humanoid').Health <= 0 or (not thismob:FindFirstChild('HumanoidRootPart') or p502()))
...
function BTP(p566)
    pcall(function()
        if (p566.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude >= 1500 and (not Auto_Raid and 0 < game.Players.LocalPlayer.Character.Humanoid.Health) then
            repeat
                wait()
                ...
                game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = p566
            until (p566.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude < 1500 and 0 < game.Players.LocalPlayer.Character.Humanoid.Health
        end
    end)
end
            ...
            pcall(function()
                ...
                if _Quest.Visible ~= false then
                    ...
                    while true do
                        ...
                        if v688.Name == MonNew and v688:FindFirstChild('HumanoidRootPart') and (v688:FindFirstChild('Humanoid') and 0 < v688.Humanoid.Health) then
                ...
                while true do
                    ...
                    if v693:FindFirstChild('Humanoid') and v693:FindFirstChild('HumanoidRootPart') and (v693.Humanoid.Health > 0 and (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - v693.HumanoidRootPart.Position).Magnitude <= 5000) then
                        repeat
                            ...
                            MonFarm = v693.Name
                        until not (_G.AutoNear and v693.Parent) or v693.Humanoid.Health <= 0 or not game.Workspace.Enemies:FindFirstChild(v693.Name)
            ...
            pcall(function()
                if game:GetService('Workspace').Enemies:FindFirstChild(_G.SelectBoss) then
                    ...
                    while true do
                        ...
                        if v700.Name == _G.SelectBoss and v700:FindFirstChild('Humanoid') and (v700:FindFirstChild('HumanoidRootPart') and 0 < v700.Humanoid.Health) then
                            repeat
                                task.wait()
                                AutoHaki()
                                EquipWeapon(_G.SelectWeapon)
                            ...
                            until not (_G.BossPain and v700.Parent) or v700.Humanoid.Health <= 0
                        end
                    end
            ...
            pcall(function()
                ...
                if (CFrame.new(-5539.3115234375, 313.800537109375, -2972.372314453125).Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude > 500 then
                    ...
                    while true do
                        ...
                        if _G.AutoRaidPirate and v706:FindFirstChild('HumanoidRootPart') and (v706:FindFirstChild('Humanoid') and 0 < v706.Humanoid.Health) and (v706.HumanoidRootPart.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude < 2000 then
                            repeat
                                wait()
                                AutoHaki()
                                EquipWeapon(_G.SelectWeapon)
            ...
            pcall(function()
                if game:GetService('Workspace').Enemies:FindFirstChild('Tyrant of the Skies') then
                    ...
                    while true do
                        ...
                        if v719.Name == 'Tyrant of the Skies' and v719:FindFirstChild('Humanoid') and (v719:FindFirstChild('HumanoidRootPart') and 0 < v719.Humanoid.Health) then
                            repeat
                                task.wait()
                                AutoHaki()
                                EquipWeapon(_G.SelectWeapon)
                                ...
                                NeedAttacking = true
                            until not (_G.FarmDaiBan and v719.Parent) or v719.Humanoid.Health <= 0
                ...
                if v729.Name ~= 'Isle Outlaw' and v729.Name ~= 'Island Boy' and (v729.Name ~= 'Isle Champion' and v729.Name ~= 'Serpent Hunter') and v729.Name ~= 'Skull Slayer' or (not (v729:FindFirstChild('Humanoid') and v729:FindFirstChild('HumanoidRootPart')) or v729.Humanoid.Health <= 0) then
                end
                if true then
                    task.wait()
                    AutoHaki()
                ...
                if game:GetService('Workspace').Enemies:FindFirstChild('Reborn Skeleton') or game:GetService('Workspace').Enemies:FindFirstChild('Living Zombie') or (game:GetService('Workspace').Enemies:FindFirstChild('Demonic Soul') or game:GetService('Workspace').Enemies:FindFirstChild('Posessed Mummy')) then
                    ...
                    while true do
                        ...
                        if (v764.Name == 'Reborn Skeleton' or v764.Name == 'Living Zombie' or (v764.Name == 'Demonic Soul' or v764.Name == 'Posessed Mummy')) and (v764:FindFirstChild('Humanoid') and v764:FindFirstChild('HumanoidRootPart') and v764.Humanoid.Health > 0) then
                            ...
                            until not (_G.FarmBone and v764.Parent) or v764.Humanoid.Health <= 0
                        end
                    end
                else
                    StartBring = false
        ...
        if _G.FarmCake then
            pcall(function()
                ...
                while true do
                    ...
                    if v784.Name ~= 'Cake Prince' or not v784:FindFirstChild('Humanoid') or (not v784:FindFirstChild('HumanoidRootPart') or 0 >= v784.Humanoid.Health) then
                    end
                    if true then
                        task.wait()
                        AutoHaki()
                    ...
                    if _G.FarmCake and v784.Parent and v784.Humanoid.Health > 0 then
                    end
                ...
                local v785, v786 = v793(v794, v785)

                if v785 == nil then
                end
                if (v786.Name == 'Cookie Crafter' or v786.Name == 'Cake Guard' or (v786.Name == 'Baking Staff' or v786.Name == 'Head Baker')) and (v786:FindFirstChild('Humanoid') and v786:FindFirstChild('HumanoidRootPart') and v786.Humanoid.Health > 0) then
                else
                end

                local v787, v788, v789 = pairs({
                    'Cookie Crafter',
                    'Cake Guard',
                    'Baking Staff',
                    'Head Baker',
                ...
                while true do
                    ...
                    v789, v791 = v787(v788, v789)

                    if v789 == nil then
                        break
                    end
                    if game:GetService('Workspace').Enemies:FindFirstChild(v791) then
                        v790 = true
                ...
                v793, v794, v785 = pairs(game:GetService('Workspace').Enemies:GetChildren())
            end)
        end
    end
end)
            ...
            pcall(function()
                if game:GetService('Workspace').Enemies:FindFirstChild(_G.SelectBoss) then
                    ...
                    while true do
                        ...
                        if v846.Name == _G.SelectBoss and v846:FindFirstChild('Humanoid') and (v846:FindFirstChild('HumanoidRootPart') and 0 < v846.Humanoid.Health) then
                            repeat
                                task.wait()
                                AutoHaki()
                                EquipWeapon(_G.SelectWeapon)
                                ...
                                sethiddenproperty(game:GetService('Players').LocalPlayer, 'SimulationRadius', math.huge)
                            until not (_G.AutoBoss and v846.Parent) or v846.Humanoid.Health <= 0
                        end
                    end
                elseif game:GetService('ReplicatedStorage'):FindFirstChild(_G.SelectBoss) then
                    topos(game:GetService('ReplicatedStorage'):FindFirstChild(_G.SelectBoss).HumanoidRootPart.CFrame * CFrame.new(5, 10, 2))
                ...
                while true do
                    ...
                    if workspace.Enemies:FindFirstChild(v854) then
                        ...
                        while true do
                            ...
                            if v858.Name == v854 and v858:FindFirstChild('Humanoid') and (v858:FindFirstChild('HumanoidRootPart') and 0 < v858.Humanoid.Health) then
                                repeat
                                    task.wait()
                                    AutoHaki()
                                    EquipWeapon(_G.SelectWeapon)
                                ...
                                until not (_G.AutoFarmMaterial and v858.Parent) or v858.Humanoid.Health <= 0
                            end
                        end
                    else
                        UnEquipWeapon(_G.SelectWeapon)
                        ...
                        if game.Workspace.Map.Ice.Door.CanCollide ~= true or game.Workspace.Map.Ice.Door.Transparency ~= 0 then
                            ...
                            elseif game:GetService('Workspace').Enemies:FindFirstChild('Ice Admiral') then
                                ...
                                while true do
                                    ...
                                    if v879.Name == 'Ice Admiral' and 0 < v879.Humanoid.Health then
                                        repeat
                                            wait()
                                            AutoHaki()
                                            EquipWeapon(_G.SelectWeapon)
                                        ...
                                        until v879.Humanoid.Health <= 0 or not v879.Parent or not _G.AutoSecondSea
                ...
                pcall(function()
                    if game:GetService('Workspace').Enemies:FindFirstChild('Greybeard') then
                        ...
                        while true do
                            ...
                            if v885.Name == 'Greybeard' and v885:FindFirstChild('Humanoid') and (v885:FindFirstChild('HumanoidRootPart') and 0 < v885.Humanoid.Health) then
                                repeat
                                    task.wait()
                                    AutoHaki()
                                    EquipWeapon(_G.SelectWeapon)
                                    ...
                                    game:GetService('VirtualUser'):Button1Down(Vector2.new(1280, 672))
                                    sethiddenproperty(game.Players.LocalPlayer, 'SimulationRadius', math.huge)
                                until not (_G.Greybeard and v885.Parent) or v885.Humanoid.Health <= 0
                            end
                        end
                    else
                                            ...
                                            if game:GetService('Workspace').Enemies:FindFirstChild('Mob Leader') or game:GetService('ReplicatedStorage'):FindFirstChild('Mob Leader') then
                                                ...
                                                while true do
                                                    ...
                                                    if v890.Name == 'Mob Leader' then
                                                        if game:GetService('Workspace').Enemies:FindFirstChild('Mob Leader') and v890:FindFirstChild('Humanoid') and (v890:FindFirstChild('HumanoidRootPart') and 0 < v890.Humanoid.Health) then
                                                            repeat
                                                                task.wait()
                                                                AutoHaki()
                                                                EquipWeapon(_G.SelectWeapon)
                ...
                pcall(function()
                    if game:GetService('Workspace').Enemies:FindFirstChild('Thunder God') then
                        ...
                        while true do
                            ...
                            if v899.Name == 'Thunder God' and v899:FindFirstChild('Humanoid') and (v899:FindFirstChild('HumanoidRootPart') and 0 < v899.Humanoid.Health) then
                                repeat
                                    task.wait()
                                    AutoHaki()
                                    EquipWeapon(_G.SelectWeapon)
                                    ...
                                    sethiddenproperty(game:GetService('Players').LocalPlayer, 'SimulationRadius', math.huge)
                                until not (_G.Autopole and v899.Parent) or v899.Humanoid.Health <= 0
                            end
                        end
                ...
                pcall(function()
                    if game:GetService('Workspace').Enemies:FindFirstChild('The Saw') then
                        ...
                        while true do
                            ...
                            if v905.Name == 'The Saw' and v905:FindFirstChild('Humanoid') and (v905:FindFirstChild('HumanoidRootPart') and 0 < v905.Humanoid.Health) then
                                repeat
                                    ...
                                    AttackNoCD()
                                until not (_G.Autosaw and v905.Parent) or v905.Humanoid.Health <= 0
                            end
                        end
                    else
                        if BypassTP then
                ...
                pcall(function()
                    if game:GetService('Workspace').Enemies:FindFirstChild('Chief Warden') then
                        ...
                        while true do
                            ...
                            if v910.Name == 'Chief Warden' and v910:FindFirstChild('Humanoid') and (v910:FindFirstChild('HumanoidRootPart') and 0 < v910.Humanoid.Health) then
                                repeat
                                    task.wait()
                                    AutoHaki()
                                    EquipWeapon(_G.SelectWeapon)
                                    ...
                                    sethiddenproperty(game:GetService('Players').LocalPlayer, 'SimulationRadius', math.huge)
                                until not (_G.ChiefWarden and v910.Parent) or v910.Humanoid.Health <= 0
                            end
                        end
                ...
                pcall(function()
                    if game:GetService('Workspace').Enemies:FindFirstChild('Fishman Lord') then
                        ...
                        while true do
                            ...
                            if v915.Name == 'Fishman Lord' and v915:FindFirstChild('Humanoid') and (v915:FindFirstChild('HumanoidRootPart') and 0 < v915.Humanoid.Health) then
                                repeat
                                    task.wait()
                                    AutoHaki()
                                    EquipWeapon(_G.SelectWeapon)
                                    ...
                                    sethiddenproperty(game:GetService('Players').LocalPlayer, 'SimulationRadius', math.huge)
                                until not (_G.Trident and v915.Parent) or v915.Humanoid.Health <= 0
                            end
                        end
                ...
                if _G.AutoFactory then
                    if game:GetService('Workspace').Enemies:FindFirstChild('Core') then
                        ...
                        while true do
                            ...
                            if v935.Name == 'Core' and 0 < v935.Humanoid.Health then
                                repeat
                                    task.wait()
                                    AutoHaki()
                                    EquipWeapon(_G.SelectWeapon)
                ...
                pcall(function()
                    if game:GetService('Workspace').Enemies:FindFirstChild('Darkbeard') then
                        ...
                        while true do
                            ...
                            if v940.Name == 'Darkbeard' and v940:FindFirstChild('Humanoid') and (v940:FindFirstChild('HumanoidRootPart') and 0 < v940.Humanoid.Health) then
                                repeat
                                    task.wait()
                                    ...
                                    sethiddenproperty(game:GetService('Players').LocalPlayer, 'SimulationRadius', math.huge)
                                until not (_G.AutoDarkBoss and v940.Parent) or v940.Humanoid.Health <= 0
                            end
                        end
                    else
                        NeedAttacking = true
                ...
                pcall(function()
                    if game:GetService('Workspace').Enemies:FindFirstChild('Cursed Captain') then
                        ...
                        while true do
                            ...
                            if v945.Name == 'Cursed Captain' and v945:FindFirstChild('Humanoid') and (v945:FindFirstChild('HumanoidRootPart') and 0 < v945.Humanoid.Health) then
                                repeat
                                    task.wait()
                                    ...
                                    sethiddenproperty(game:GetService('Players').LocalPlayer, 'SimulationRadius', math.huge)
                                until not (_G.CursedCaptain and v945.Parent) or v945.Humanoid.Health <= 0
                            end
                        end
                    else
                        NeedAttacking = true
                ...
                pcall(function()
                    if game:GetService('Workspace').Enemies:FindFirstChild('Diamond') then
                        ...
                        while true do
                            ...
                            if v952.Name == 'Diamond' and v952:FindFirstChild('Humanoid') and (v952:FindFirstChild('HumanoidRootPart') and 0 < v952.Humanoid.Health) then
                                repeat
                                    task.wait()
                                    AutoHaki()
                                    EquipWeapon(_G.SelectWeapon)
                                    ...
                                    sethiddenproperty(game:GetService('Players').LocalPlayer, 'SimulationRadius', math.huge)
                                until not (_G.Longsword and v952.Parent) or v952.Humanoid.Health <= 0
                            end
                        end
                ...
                pcall(function()
                    if game:GetService('Workspace').Enemies:FindFirstChild('Fajita') then
                        ...
                        while true do
                            ...
                            if v957.Name == 'Fajita' and v957:FindFirstChild('Humanoid') and (v957:FindFirstChild('HumanoidRootPart') and 0 < v957.Humanoid.Health) then
                                repeat
                                    task.wait()
                                    AutoHaki()
                                    EquipWeapon(_G.SelectWeapon)
                                    ...
                                    sethiddenproperty(game:GetService('Players').LocalPlayer, 'SimulationRadius', math.huge)
                                until not (_G.GravityBlade and v957.Parent) or v957.Humanoid.Health <= 0
                            end
                        end
                ...
                pcall(function()
                    if game:GetService('Workspace').Enemies:FindFirstChild('Smoke Admiral') then
                        ...
                        while true do
                            ...
                            if v962.Name == 'Smoke Admiral' and v962:FindFirstChild('Humanoid') and (v962:FindFirstChild('HumanoidRootPart') and 0 < v962.Humanoid.Health) then
                                repeat
                                    task.wait()
                                    AutoHaki()
                                    EquipWeapon(_G.SelectWeapon)
                                    ...
                                    sethiddenproperty(game:GetService('Players').LocalPlayer, 'SimulationRadius', math.huge)
                                until not (_G.SwodsFlail and v962.Parent) or v962.Humanoid.Health <= 0
                            end
                        end
                ...
                if _G.AutoRengoku then
                    ...
                    elseif game:GetService('Workspace').Enemies:FindFirstChild('Awakened Ice Admiral') then
                        ...
                        while true do
                            ...
                            if v967.Name == 'Awakened Ice Admiral' and v967:FindFirstChild('Humanoid') and (v967:FindFirstChild('HumanoidRootPart') and 0 < v967.Humanoid.Health) then
                                repeat
                                    task.wait()
                                    EquipWeapon(_G.SelectWeapon)
                                    AutoHaki()
                ...
                pcall(function()
                    if game:GetService('Workspace').Enemies:FindFirstChild('Tide Keeper') then
                        ...
                        while true do
                            ...
                            if v972.Name == 'Tide Keeper' and v972:FindFirstChild('Humanoid') and (v972:FindFirstChild('HumanoidRootPart') and 0 < v972.Humanoid.Health) then
                                repeat
                                    task.wait()
                                    AutoHaki()
                                    EquipWeapon(_G.SelectWeapon)
                                    ...
                                    sethiddenproperty(game:GetService('Players').LocalPlayer, 'SimulationRadius', math.huge)
                                until not (_G.SwodsDRTrident and v972.Parent) or v972.Humanoid.Health <= 0
                            end
                        end
                ...
                if _G.RipIndraKill then
                    if game:GetService('Workspace').Enemies:FindFirstChild('rip_indra True Form') or game:GetService('Workspace').Enemies:FindFirstChild('rip_indra') then
                        ...
                        while true do
                            ...
                            if _Name == v980 and 0 < u981.Humanoid.Health and (u981:IsA('Model') and u981:FindFirstChild('Humanoid')) and u981:FindFirstChild('HumanoidRootPart') then
                                repeat
                                    task.wait()
                                    pcall(function()
                                        AutoHaki()
            ...
            pcall(function()
                ...
                if _Enemies2:FindFirstChild('Cursed Skeleton Boss') then
                    ...
                    while true do
                        ...
                        if v1017.Name == 'Cursed Skeleton Boss' and v1017:FindFirstChild('Humanoid') and (v1017:FindFirstChild('HumanoidRootPart') and 0 < v1017.Humanoid.Health) then
                            ...
                            repeat
                                task.wait()
                            until not (getgenv().AutoGetCDK and v1017.Parent) or v1017.Humanoid.Health <= 0
                        end
                    end
                else
                ...
                pcall(function()
                    if game:GetService('Workspace').Enemies:FindFirstChild('Longma') then
                        ...
                        while true do
                            ...
                            if v1026.Name == 'Longma' and v1026:FindFirstChild('Humanoid') and (v1026:FindFirstChild('HumanoidRootPart') and 0 < v1026.Humanoid.Health) then
                                repeat
                                    task.wait()
                                    AutoHaki()
                                    EquipWeapon(_G.SelectWeapon)
                                    ...
                                    sethiddenproperty(game:GetService('Players').LocalPlayer, 'SimulationRadius', math.huge)
                                until not (_G.AutoGetTushita and v1026.Parent) or v1026.Humanoid.Health <= 0
                            end
                        end
                ...
                pcall(function()
                    if game:GetService('Workspace').Enemies:FindFirstChild('Captain Elephant') then
                        ...
                        while true do
                            ...
                            if v1031.Name == 'Captain Elephant' and v1031:FindFirstChild('Humanoid') and (v1031:FindFirstChild('HumanoidRootPart') and 0 < v1031.Humanoid.Health) then
                                repeat
                                    task.wait()
                                    AutoHaki()
                                    EquipWeapon(_G.SelectWeapon)
                                    ...
                                    sethiddenproperty(game:GetService('Players').LocalPlayer, 'SimulationRadius', math.huge)
                                until not (_G.SwodTwinHooks and v1031.Parent) or v1031.Humanoid.Health <= 0
                            end
                        end
                ...
                pcall(function()
                    if game:GetService('Workspace').Enemies:FindFirstChild('Beautiful Pirate') then
                        ...
                        while true do
                            ...
                            if v1036.Name == 'Beautiful Pirate' and v1036:FindFirstChild('Humanoid') and (v1036:FindFirstChild('HumanoidRootPart') and 0 < v1036.Humanoid.Health) then
                                repeat
                                    task.wait()
                                    AutoHaki()
                                    EquipWeapon(_G.SelectWeapon)
                                    ...
                                    sethiddenproperty(game:GetService('Players').LocalPlayer, 'SimulationRadius', math.huge)
                                until not (_G.SwodCanvander and v1036.Parent) or v1036.Humanoid.Health <= 0
                            end
                        end
                ...
                pcall(function()
                    if game:GetService('Workspace').Enemies:FindFirstChild('Cake Queen') then
                        ...
                        while true do
                            ...
                            if v1041.Name == 'Cake Queen' and v1041:FindFirstChild('Humanoid') and (v1041:FindFirstChild('HumanoidRootPart') and 0 < v1041.Humanoid.Health) then
                                repeat
                                    task.wait()
                                    AutoHaki()
                                    EquipWeapon(_G.SelectWeapon)
                                    ...
                                    sethiddenproperty(game:GetService('Players').LocalPlayer, 'SimulationRadius', math.huge)
                                until not (_G.SwodsBuddy and v1041.Parent) or v1041.Humanoid.Health <= 0
                            end
                        end
            ...
            pcall(function()
                ...
                if v1068 == 1 then
                    if v1067 == 'Hydra Enforcer' or v1067 == 'Venomous Assailant' then
                        ...
                        until not (_G.FarmBlazeEM and v1066) or BackTODoJo()
                    end
                    ...
                    while true do
                        ...
                        if not (_G.FarmBlazeEM and v1066) or BackTODoJo() then
                        end
                    end
                end
            end)
            ...
            pcall(function()
                if game:GetService('Workspace').Enemies:FindFirstChild('Lava Golem') then
                    ...
                    while true do
                        ...
                        if v1164.Name == 'Lava Golem' and v1164:FindFirstChild('Humanoid') and (v1164:FindFirstChild('HumanoidRootPart') and 0 < v1164.Humanoid.Health) then
                            repeat
                                task.wait()
                                AutoHaki()
                                EquipWeapon(_G.SelectWeapon)
                                ...
                                sethiddenproperty(game.Players.LocalPlayer, 'SimulationRadius', math.huge)
                            until not (_G.KillGolem and v1164.Parent) or v1164.Humanoid.Health <= 0
                        end
                    end
                else
                    UnEquipWeapon(_G.SelectWeapon)
                    ...
                    while true do
                        ...
                        if u1174:FindFirstChild('Humanoid') and u1174:FindFirstChild('HumanoidRootPart') and (u1174.Humanoid.Health > 0 and (u1174.HumanoidRootPart.Position - v1168).Magnitude <= 1000) then
                            pcall(function()
                                ...
                                until not (_G.Kill_Aura and u1174.Parent) or u1174.Humanoid.Health <= 0
                            end)
                        end
                    end
                end
        ...
        if _G.Autoterrorshark and World3 then
            pcall(function()
                ...
                while true do
                    ...
                    if v1204.Name == 'Terrorshark' and v1204:FindFirstChild('Humanoid') and (v1204:FindFirstChild('HumanoidRootPart') and 0 < v1204.Humanoid.Health) then
                        while true do
                            if true then
                                task.wait()
                                AutoHaki()
                            ...
                            if not (_G.Autoterrorshark and v1204.Parent) or v1204.Humanoid.Health <= 0 then
                            end
                        end
                    end
                end
            ...
            pcall(function()
                if game:GetService('Workspace').Enemies:FindFirstChild('Shark') or (game:GetService('Workspace').Enemies:FindFirstChild('Piranha') or game:GetService('Workspace').Enemies:FindFirstChild('Fish Crew Member')) or (game:GetService('Workspace').Enemies:FindFirstChild('Terrorshark') or game:GetService('Workspace').SeaBeasts:FindFirstChild('SeaBeast1') or (game:GetService('Workspace').Enemies:FindFirstChild('PirateBrigade') or game:GetService('Workspace').Enemies:FindFirstChild('PirateBasic'))) then
                    ...
                    while true do
                        ...
                        if v1228.Name == 'Shark' and v1228:FindFirstChild('Humanoid') and (v1228:FindFirstChild('HumanoidRootPart') and 0 < v1228.Humanoid.Health) then
                            repeat
                                task.wait()
                                AutoHaki()
                                EquipWeapon(_G.SelectWeapon)
                                ...
                                game.Players.LocalPlayer.Character.Humanoid.Sit = false
                            until not (_G.KillShark and v1228.Parent) or v1228.Humanoid.Health <= 0
                        end
                    end
                else
                    topos(game:GetService('Workspace').Boats.PirateBrigade.VehicleSeat.CFrame * CFrame.new(0, -1, 0))
            ...
            pcall(function()
                if game:GetService('Workspace').Enemies:FindFirstChild('Piranha') or (game:GetService('Workspace').Enemies:FindFirstChild('Shark') or game:GetService('Workspace').Enemies:FindFirstChild('Fish Crew Member')) or (game:GetService('Workspace').Enemies:FindFirstChild('Terrorshark') or game:GetService('Workspace').SeaBeasts:FindFirstChild('SeaBeast1') or (game:GetService('Workspace').Enemies:FindFirstChild('PirateBrigade') or game:GetService('Workspace').Enemies:FindFirstChild('PirateBasic'))) then
                    ...
                    while true do
                        ...
                        if v1237.Name == 'Piranha' and v1237:FindFirstChild('Humanoid') and (v1237:FindFirstChild('HumanoidRootPart') and 0 < v1237.Humanoid.Health) then
                            repeat
                                task.wait()
                                AutoHaki()
                                EquipWeapon(_G.SelectWeapon)
                                ...
                                game.Players.LocalPlayer.Character.Humanoid.Sit = false
                            until not (_G.KillPiranha and v1237.Parent) or v1237.Humanoid.Health <= 0
                        end
                    end
                else
                    topos(game:GetService('Workspace').Boats.PirateBrigade.VehicleSeat.CFrame * CFrame.new(0, -1, 0))
            ...
            pcall(function()
                if game:GetService('Workspace').Enemies:FindFirstChild('Fish Crew Member') or (game:GetService('Workspace').Enemies:FindFirstChild('Piranha') or game:GetService('Workspace').Enemies:FindFirstChild('Shark')) or (game:GetService('Workspace').Enemies:FindFirstChild('Terrorshark') or game:GetService('Workspace').SeaBeasts:FindFirstChild('SeaBeast1') or (game:GetService('Workspace').Enemies:FindFirstChild('PirateBrigade') or game:GetService('Workspace').Enemies:FindFirstChild('PirateBasic'))) then
                    ...
                    while true do
                        ...
                        if v1246.Name == 'Fish Crew Member' and v1246:FindFirstChild('Humanoid') and (v1246:FindFirstChild('HumanoidRootPart') and 0 < v1246.Humanoid.Health) then
                            repeat
                                task.wait()
                                AutoHaki()
                                EquipWeapon(_G.SelectWeapon)
                                ...
                                game.Players.LocalPlayer.Character.Humanoid.Sit = false
                            until not (_G.KillFishCrew and v1246.Parent) or v1246.Humanoid.Health <= 0
                        end
                    end
                else
                    topos(game:GetService('Workspace').Boats.PirateBrigade.VehicleSeat.CFrame * CFrame.new(0, -1, 0))
                                    ...
                                    if u1297:FindFirstChild('Humanoid') and u1297:FindFirstChild('HumanoidRootPart') and u1297.Humanoid.Health > 0 then
                                        pcall(function()
                                            repeat
                                                ...
                                                sethiddenproperty(game.Players.LocalPlayer, 'SimulationRadius', math.huge)
                                            until not (_G.AutoQuestRace and u1297.Parent) or u1297.Humanoid.Health <= 0
                                        end)
                                    end
                                end
                            end
                        ...
                        if u1306:FindFirstChild('Humanoid') and u1306:FindFirstChild('HumanoidRootPart') and u1306.Humanoid.Health > 0 then
                            pcall(function()
                                repeat
                                    ...
                                    sethiddenproperty(game.Players.LocalPlayer, 'SimulationRadius', math.huge)
                                until not (_G.AutoQuestRace and u1306.Parent) or u1306.Humanoid.Health <= 0
                            end)
                        end
                    end
                end
        ...
        if _G.AutoKillV4 then
            pcall(function()
                ...
                while true do
                    ...
                    if v1311.Name ~= game.Players.LocalPlayer.Name and v1311:FindFirstChild('Humanoid') and (v1311:FindFirstChild('HumanoidRootPart') and 0 < v1311.Humanoid.Health) and (v1311.Parent and (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - v1311.HumanoidRootPart.Position).Magnitude <= 230) then
                        repeat
                            task.wait()
                            AutoHaki()
                            EquipWeapon(_G.SelectWeapon)
                            ...
                            sethiddenproperty(game.Players.LocalPlayer, 'SimulationRadius', math.huge)
                        until not _G.AutoKillV4 or v1311.Humanoid.Health <= 0 or not (v1311.Parent and v1311:FindFirstChild('HumanoidRootPart')) or not v1311:FindFirstChild('Humanoid')
                    end
                end
            end)
        end
    ...
    while task.wait() do
        pcall(function()
            if _G.StartRaid then
                ...
                if not (_LocalPlayer14.PlayerGui.Main.Timer.Visible or workspace._WorldOrigin.Locations:FindFirstChild('Island 1')) and (_LocalPlayer14.Backpack:FindFirstChild('Special Microchip') or _LocalPlayer14.Character:FindFirstChild('Special Microchip')) then
                    if World2 then
...
local function u1346()
    ...
    while true do
        ...
        if v1345:FindFirstChild('Humanoid') and 0 < v1345.Humanoid.Health then
            EquipWeapon(_G.SelectWeapon)
            ...
            pcall(function()
                if game:GetService('Workspace').Enemies:FindFirstChild('Order') then
                    ...
                    while true do
                        ...
                        if v1352.Name == 'Order' and v1352:FindFirstChild('Humanoid') and (v1352:FindFirstChild('HumanoidRootPart') and 0 < v1352.Humanoid.Health) then
                            repeat
                                task.wait()
                                AutoHaki()
                                EquipWeapon(_G.SelectWeapon)
                                ...
                                sethiddenproperty(game:GetService('Players').LocalPlayer, 'SimulationRadius', math.huge)
                            until not (_G.AutoLawRaid and v1352.Parent) or v1352.Humanoid.Health <= 0
                        end
                    end
                else
                    NeedAttacking = true
    ...
    while task.wait() do
        pcall(function()
            ...
            while true do
                ...
                if _G.BringMonster and (StartBring and v1445.Name == MonFarm or v1445.Name == Mon and v1445:FindFirstChild('Humanoid') and (v1445:FindFirstChild('HumanoidRootPart') and 0 < v1445.Humanoid.Health) and (v1445.HumanoidRootPart.Position - game:GetService('Players').LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 320) then
